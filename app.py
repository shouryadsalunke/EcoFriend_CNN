...
st.caption("AI-powered smart waste segregation — upload an image to classify it into one of six categories.")
...
with tab_analytics:
    ...
    try:
        st.image(DASHBOARD_IMAGE_PATH, use_column_width=True)
    except Exception:
